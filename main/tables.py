...
class DriverColumn(tables.Column):
	def render(self, record):
		return mark_safe('<img id="driver-img" width="150px" data-id='+str(record.driver.id) +' data-toggle="modal" data-target="#myModal" src="%s" />' % escape(record.driver.featured_image.url))
