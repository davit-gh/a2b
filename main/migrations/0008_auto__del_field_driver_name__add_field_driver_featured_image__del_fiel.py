...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Driver.name'
        db.delete_column(u'main_driver', 'name')

        # Adding field 'Driver.featured_image'
        db.add_column(u'main_driver', 'featured_image',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Ride.featured_image'
        db.delete_column(u'main_ride', 'featured_image')


    def backwards(self, orm):
        # Adding field 'Driver.name'
        db.add_column(u'main_driver', 'name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Deleting field 'Driver.featured_image'
        db.delete_column(u'main_driver', 'featured_image')

        # Adding field 'Ride.featured_image'
        db.add_column(u'main_ride', 'featured_image',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)
