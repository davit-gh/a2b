...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Streets'
        db.create_table(u'main_streets', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name_en', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('name_hy', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'main', ['Streets'])


    def backwards(self, orm):
        # Deleting model 'Streets'
        db.delete_table(u'main_streets')
