...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Driver.ride'
        db.delete_column(u'main_driver', 'ride_id')

        # Adding field 'Ride.driver'
        db.add_column(u'main_ride', 'driver',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='rides', to=orm['main.Driver']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Driver.ride'
        db.add_column(u'main_driver', 'ride',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='rides', to=orm['main.Ride']),
                      keep_default=False)

        # Deleting field 'Ride.driver'
        db.delete_column(u'main_ride', 'driver_id')
