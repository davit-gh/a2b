...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Driver.id'
        db.delete_column(u'main_driver', u'id')

        # Adding field 'Driver.page_ptr'
        db.add_column(u'main_driver', u'page_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['pages.Page'], unique=True, primary_key=True),
                      keep_default=False)

        # Adding field 'Driver.content'
        db.add_column(u'main_driver', 'content',
                      self.gf('mezzanine.core.fields.RichTextField')(default=1),
                      keep_default=False)

        # Adding field 'Ride._order'
        db.add_column(u'main_ride', '_order',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Driver.id'
        db.add_column(u'main_driver', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Deleting field 'Driver.page_ptr'
        db.delete_column(u'main_driver', u'page_ptr_id')

        # Deleting field 'Driver.content'
        db.delete_column(u'main_driver', 'content')

        # Deleting field 'Ride._order'
        db.delete_column(u'main_ride', '_order')
    ...
    models = {
        ...
        u'main.driver': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Driver', '_ormbases': [u'pages.Page']},
        ...
        u'main.ride': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Ride'},
            '_order': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'driver': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rides'", 'to': u"orm['main.Driver']"}),
            'featured_image': ('mezzanine.core.fields.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'fromwhere': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'leavedate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'towhere': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'main.ridesearch': {
            'Meta': {'object_name': 'Ridesearch'},
            'fromwhere': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'leavedate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
