...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Ridesearch'
        db.create_table(u'main_ridesearch', (
            ...
            ('passanger_number', self.gf('django.db.models.fields.CharField')(max_length=3)),
        ))
        db.send_create_signal(u'main', ['Ridesearch'])


    def backwards(self, orm):
        # Deleting model 'Ridesearch'
        db.delete_table(u'main_ridesearch')
