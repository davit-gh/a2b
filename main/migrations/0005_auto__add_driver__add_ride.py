...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Driver'
        db.create_table(u'main_driver', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('ride', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rides', to=orm['main.Ride'])),
        ))
        db.send_create_signal(u'main', ['Driver'])

        # Adding model 'Ride'
        db.create_table(u'main_ride', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fromwhere', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('towhere', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('leavedate', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('featured_image', self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'main', ['Ride'])


    def backwards(self, orm):
        # Deleting model 'Driver'
        db.delete_table(u'main_driver')

        # Deleting model 'Ride'
        db.delete_table(u'main_ride')
    ...
    models = {
        ...
        u'main.driver': {
            ...
            'ride': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rides'", 'to': u"orm['main.Ride']"})
        },
        u'main.homepage': {
