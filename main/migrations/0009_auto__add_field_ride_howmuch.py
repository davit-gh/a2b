...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ride.howmuch'
        db.add_column(u'main_ride', 'howmuch',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ride.howmuch'
        db.delete_column(u'main_ride', 'howmuch')
    ...
    models = {
        ...
        u'main.ride': {
            ...
            'howmuch': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
